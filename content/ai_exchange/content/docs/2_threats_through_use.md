...
- [OpenCRE: Evasion (e.g. adversarial examples)](https://staging.opencre.org/cre/370-877)
    ...
    - [OWASP Top10 for ML: Input Manipulation Attack](https://mltop10.info/ML01_2023-Input_Manipulation_Attack.html)
    - [BIML: Adversarial Examples](https://berryvilleiml.com/results/interactive)
    - [NIST AI 100-2: Evasion Attacks](https://csrc.nist.gov/pubs/ai/100/2/e2023/final)
...
- [OpenCRE: Evasion attack input handling](https://staging.opencre.org/cre/761-417)
    ...
    - [MITRE ATLAS: Use Multi-Modal Sensors](https://atlas.mitre.org/mitigations/AML.M0009)
...
- [OpenCRE: Direct prompt injection](https://staging.opencre.org/cre/686-110)
    ...
    - [ENISA: Evasion](https://www.enisa.europa.eu/publications/securing-machine-learning-algorithms)
    - [BIML: Prompt Injection](https://berryvilleiml.com/results/BIML-LLM24.pdf)
    - [NIST AI 100-2: Direct Prompt Injection Attacks](https://csrc.nist.gov/pubs/ai/100/2/e2023/final)
...
- [OpenCRE: Indirect prompt injection](https://staging.opencre.org/cre/012-625)
    ...
    - [ENISA: Evasion](https://www.enisa.europa.eu/publications/securing-machine-learning-algorithms)
    - [BIML: Prompt Injection](https://berryvilleiml.com/results/BIML-LLM24.pdf)
    - [NIST AI 100-2: Indirect Prompt Injection Attacks](https://csrc.nist.gov/pubs/ai/100/2/e2023/final)
...
- [OpenCRE: Model inversion / Membership inference](https://staging.opencre.org/cre/034-540)
    ...
    - [ETSI: Model inversion attacks](https://www.etsi.org/deliver/etsi_gr/SAI/001_099/005/01.01.01_60/gr_SAI005v010101p.pdf)
    - [ETSI: Membership inference attacks](https://www.etsi.org/deliver/etsi_gr/SAI/001_099/005/01.01.01_60/gr_SAI005v010101p.pdf)
    - [OWASP Top10 for ML: Model Inversion Attack](https://mltop10.info/ML03_2023-Model_Inversion_Attack.html)
    - [OWASP Top10 for ML: Membership Inference Attack](https://mltop10.info/ML04_2023-Membership_Inference_Attack.html)
    - [BIML: Training Set and Prompt Reveal](https://berryvilleiml.com/results/BIML-LLM24.pdf)
    - [BIML: Training Set Reveal](https://berryvilleiml.com/results/interactive)
    - [NIST AI 100-2: Membership Inference](https://csrc.nist.gov/pubs/ai/100/2/e2023/final)
    - [ENISA: Oracle](https://www.enisa.europa.eu/publications/securing-machine-learning-algorithms)
...
- [OpenCRE: Model exfiltration](https://staging.opencre.org/cre/141-385)
    ...
    - [BIML: Steal the Box](https://berryvilleiml.com/results/interactive)
    - [NIST AI 100-2: Model Extraction](https://csrc.nist.gov/pubs/ai/100/2/e2023/final)
    - [ENISA: Model disclosure](https://www.enisa.europa.eu/publications/securing-machine-learning-algorithms)
