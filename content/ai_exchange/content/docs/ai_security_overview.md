...
- The **OWASP AISVS** (AI Security Verification Standard) is a catalogue of testable security requirements for AI-enabled systems, modeled after OWASP ASVS, to help developers and auditors verify AI application security across the full lifecycle.
...
- If you want to **verify the security of your AI application** against a concrete checklist of testable requirements, use the [OWASP AISVS](https://owasp.org/www-project-artificial-intelligence-security-verification-standard-aisvs-docs/).
...
- The [OWASP AISVS](https://owasp.org/www-project-artificial-intelligence-security-verification-standard-aisvs-docs/) (Artificial Intelligence Security Verification Standard) is a community-driven catalogue of testable security requirements for AI-enabled systems, modeled after the OWASP ASVS. It provides three verification levels and covers the full AI lifecycle from training data integrity to deployment monitoring, helping developers, architects, and auditors build and verify secure AI applications.
